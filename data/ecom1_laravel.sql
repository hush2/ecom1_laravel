...
-- Dumping structure for table ecom1_laravel.categories
...
-- Dumping data for table ecom1_laravel.categories: 5 rows
...
-- Dumping structure for table ecom1_laravel.favorite_pages
...
-- Dumping data for table ecom1_laravel.favorite_pages: 0 rows
/*!40000 ALTER TABLE `favorite_pages` DISABLE KEYS */;
/*!40000 ALTER TABLE `favorite_pages` ENABLE KEYS */;


-- Dumping structure for table ecom1_laravel.history
...
-- Dumping data for table ecom1_laravel.history: 0 rows
/*!40000 ALTER TABLE `history` DISABLE KEYS */;
/*!40000 ALTER TABLE `history` ENABLE KEYS */;


-- Dumping structure for table ecom1_laravel.pages
...
CREATE TABLE IF NOT EXISTS `pdfs` (
  ...
  KEY `date_created` (`created_at`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- Dumping data for table ecom1_laravel.pdfs: 4 rows
/*!40000 ALTER TABLE `pdfs` DISABLE KEYS */;
INSERT IGNORE INTO `pdfs` (`id`, `tmp_name`, `title`, `description`, `file_name`, `size`, `created_at`, `updated_at`) VALUES
	(1, '1bd099739815004654588c378ad93048c3c6e764', 'Javascript Cheat Sheet', 'Javascript Cheat Sheet v1', 'javascript-cheat-sheet-v1.pdf', 453, '2012-09-05 10:44:43', '0000-00-00 00:00:00'),
	(2, '8940fcd20f23fb39775c4e9ef3ea9403ba7056cc', 'mod_rewrite Cheat Sheet', 'mod_rewrite Cheat Sheet v2', 'mod_rewrite-cheat-sheet-v2.pdf', 563, '2012-09-05 10:44:58', '0000-00-00 00:00:00'),
	(3, '7d20b8c7df931654fda7a9acad10cc914d42037b', 'MySQL Cheat Sheet', 'MySQL Cheat Sheet v1', 'mysql-cheat-sheet-v1.pdf', 347, '2012-09-05 10:45:10', '0000-00-00 00:00:00'),
	(4, 'e44b84ac5d7eabdaa4b3e899932ad06e497273c9', 'PHP Cheat Sheet', 'PHP Cheat Sheet v2', 'php-cheat-sheet-v2.pdf', 543, '2012-09-05 10:45:21', '0000-00-00 00:00:00');
/*!40000 ALTER TABLE `pdfs` ENABLE KEYS */;


-- Dumping structure for table ecom1_laravel.users
...
-- Dumping data for table ecom1_laravel.users: 3 rows
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT IGNORE INTO `users` (`id`, `type`, `username`, `email`, `pass`, `first_name`, `last_name`, `date_expires`, `created_at`, `updated_at`) VALUES
	(1, 'admin', 'admin', 'admin@example.com', '$2a$08$s9zpHMg.I2UmqCzKIbwPFuWLPjuSmXkHaGKw4sw75MSc.6Y67XwMS', 'admin', 'admin', '2012-10-03', '2012-09-03 08:57:08', NULL),
	(2, 'member', 'demo', 'demo@example.com', '$2a$08$eGi1dZa1fGcIpLIVkxcH4uJTDXppxMAvbxa3Vj7LuFnjDI98nQ6PO', 'demo', 'demo', '2012-10-03', '2012-09-03 08:57:55', NULL),
	(3, 'member', 'demo2', 'demo2@example.com', '$2a$08$XkWUGVDj1Rk0JynhuqIgv.j2lMmcVCWMHy9DdBXUMJRMCeCH63lra', 'demo2', 'demo2', '2012-08-03', '2012-09-03 08:58:17', NULL);
